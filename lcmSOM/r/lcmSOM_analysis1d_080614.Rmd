...
This will be doing SOMs based on the full list of DE genes as generated from Analysis5. All
...
names(data.val)[21] <- "unit.classif"
...
write.table(data.val, file="../data/analysis1.som.data.ALLC.txt")
...
```{r}
plot.data <- read.table("../data/analysis1.som.data.ALLC.txt",header=TRUE)
...
write.table(data.val.small, file="../data/analysis1.som.data.small.ALLC.txt")
#Make sure that there is just one of each value som$unit.classif and distances column. 
